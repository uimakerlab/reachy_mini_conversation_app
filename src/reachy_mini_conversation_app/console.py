...
class LocalStream:
    ...
    def __init__(
        ...
        *,
        ...
        - ``transcript_callback``: optional callback invoked for each transcript message
          (user/assistant text) so the Gradio UI chatbot can display them.
        """
