"""Tool: turn the robot 90 degrees to the right and stay turned."""
...
class TurnRight(Tool):
    ...
    name = "turn_right"
    description = (
        "Turn your whole body 90 degrees to the right and stay facing that direction. "
    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> Dict[str, Any]:
        """Turn right and stay."""
        logger.info("Tool call: turn_right")
